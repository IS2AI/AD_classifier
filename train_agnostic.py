...
import math
import pandas as pd
from classes import ThreeInputsTextReader,ResNet18,MyEnsemble
...
def get_args():
    ...
    parser.add_argument('--output_path', type=str, default='/checkpoints/agnostic/model1_upd.pt')
...
dset_train = ThreeInputsTextReader(IMG_PATH_1, IMG_PATH_2,IMG_PATH_3,TRAINING_PATH, transforms_train)
dset_test = ThreeInputsTextReader(IMG_PATH_4, IMG_PATH_5,IMG_PATH_6, TESTING_PATH, transforms_test)
